...
for ($i = 1; $i <= $totalPages; $i++) {
    ...
    $links .= "<li class='$active'><a href='biznes.php?page=$i'>$i</a></li>";
}

$result=$conn->query("SELECT * FROM posts WHERE n_type = 'biznes' ORDER BY id DESC LIMIT $start, $soni");
  ...
  <section id="pagination-2" class="pagination-2 section">
    <div class="container">
      <div class="d-flex justify-content-center">
        <ul class="pagination">
          <li><a href="biznes.php?page=<?= ($page > 1) ? $page - 1 : 1 ?>"><i class="bi bi-chevron-left"></i></a></li>
          <?= $links ?>
          <li><a href="biznes.php?page=<?= ($page < $totalPages) ? $page + 1 : $totalPages ?>"><i class="bi bi-chevron-right"></i></a></li>
        </ul>
      </div>
    </div>
  </section>
