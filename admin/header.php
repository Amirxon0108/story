  ...
  <?php if (isset($_SESSION['logged_in']) && $_SESSION['logged_in'] === true): ?>
    <a class="nav-link dropdown-toggle" href="profile.php" id="userDropdown" role="button"
       data-bs-toggle="dropdown" aria-expanded="false">
        ...
        <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?= htmlspecialchars($_SESSION['user']['user_name'] ?? 'User', ENT_QUOTES, 'UTF-8') ?></span>
        <img class="img-profile rounded-circle" src="img/undraw_profile.svg" alt="profile" style="width:30px; height:30px;">
    </a>
    ...
    <ul class="dropdown-menu dropdown-menu-end shadow animated--grow-in" aria-labelledby="userDropdown">
        ...
        <li><a class="dropdown-item" href="activity.php"><i class="fas fa-list fa-sm fa-fw me-2 text-gray-400"></i> Activity Log</a></li>
